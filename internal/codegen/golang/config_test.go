...
func TestParseConfig_Defaults(t *testing.T) {
	cfg, err := golang.ParseConfig(nil, "github.com/acme/events", "/registry/root")
	if err != nil {
...
func TestParseConfig_EmptyRaw_Defaults(t *testing.T) {
	cfg, err := golang.ParseConfig(map[string]any{}, "github.com/acme/events", "/registry/root")
	if err != nil {
		t.Fatalf("ParseConfig() error = %v, want nil", err)
	}
	if cfg.Out != "./gen/go" {
...
func TestParseConfig_Overrides(t *testing.T) {
	...
	cfg, err := golang.ParseConfig(raw, "github.com/acme/events", "/registry/root")
	if err != nil {
		t.Fatalf("ParseConfig() error = %v, want nil", err)
	}
...
func TestParseConfig_InvalidOutType(t *testing.T) {
	...
	_, err := golang.ParseConfig(raw, "github.com/acme/events", "/registry/root")
	if err == nil {
